...
*(It's pronounced compute by the way, the X represents the multi-network architecture of the system)*
...
- **Decentralized AI Inference** – The Cxmpute API hosts a vast selection of models, offering a serverless inference service. Users can also host dedicated models exclusively for their own use.
...
### Getting Started
Cxmpute is designed with simplicity in mind. From past experience, I’ve learned that usability is key—so the website and onboarding process are redundant-proof, straightforward, and user-friendly. Getting started is easy—just visit **cxmpute.cloud**.
