      ...
      <ul className="font-sm mt-8 flex flex-col space-x-0 space-y-2 text-neutral-600 md:flex-row md:space-x-4 md:space-y-0">
        ...
        <li>
          <a
            ...
            rel="noopener noreferrer"
            target="_blank"
            href="https://www.cxmpute.cloud"
          >
            <ArrowIcon />
            <p className="ml-2 h-7">Cxmpute</p>
          </a>
        </li>
        <li>
          <a
            ...
            rel="noopener noreferrer"
            target="_blank"
            href="https://levlex.xyz"
          >
            <ArrowIcon />
            <p className="ml-2 h-7">Levlex</p>
          </a>
        </li>
        <li>
          <a
        ...
        <li>
          <a
            ...
            rel="noopener noreferrer"
            target="_blank"
            href="https://www.linkedin.com/in/joshua-okolo/"
          >
            <ArrowIcon />
